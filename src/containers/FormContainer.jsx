...
class FormContainer extends Component {
    ...
    handleFullNameChange(e) {
        ...
        // let ownerNameValid = e.target.value >= 3 ? '' : ' is to short';
        // fieldValidationErrors.ownerName = ownerNameValid ? '': ' is too short';
        this.setState({ 
                        ownerName: value
						// ownerNameValid: ownerNameValid
    ...
    validateField(fieldName, value) {
        ...
        let ownerNameValid = this.state.ownerNameValid;
    ...
    validateForm() {
        this.setState({formValid: this.state.ownerNameValid && this.state.ownerNameValid});
    }
